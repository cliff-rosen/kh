    ...
    try:
        ...
        included_articles = [
            CurationIncludedArticle(
                ...
                ai_summary=item.association.ai_enrichments.get("summary") if item.association.ai_enrichments else None,
                original_ai_summary=item.association.original_ai_enrichments.get("summary") if item.association.original_ai_enrichments else None,
                ...
                curator_added=item.curator_added,
