...
export default function SemanticFilterStep() {
    ...
    const handleThresholdChange = (newThreshold: number) => {
        // Just update local state - will be saved when user completes
        setThreshold(newThreshold);
    };

    const handleComplete = async () => {
        // Save threshold before completing
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-white dark:bg-gray-800">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                        {/* Show Generate button when awaiting generation */}
                        {filterSubState === 'awaiting_generation' && !isGenerating && (
                            <button
                        ...
                        {/* Show Edit/Regenerate when filter is generated */}
                        {filterSubState === 'filter_generated' && !isEditing && (
                            <>
                                <button
            ...
            {/* Threshold Configuration - only show when filter is generated */}
            {filterSubState === 'filter_generated' && !isEditing && (
                <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-white dark:bg-gray-800">
            ...
            {/* Complete Filter Button - only show when filter is generated and not editing */}
            {filterSubState === 'filter_generated' && !isEditing && (
